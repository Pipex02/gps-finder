document.addEventListener('DOMContentLoaded', function() {
    ...
    // Se aumentan las dimensiones para que el speedometer sea un poco más grande
    svg.setAttribute("width", "180");   // aumentado de 140px a 180px
    svg.setAttribute("height", "140");    // aumentado de 100px a 130px
    // Se mantiene el viewBox para escalar proporcionalmente
    ...
    for (let i = 0; i <= 10; i++) {
        ...
        if (i % 2 === 0) {
            ...
            text.setAttribute("font-size", "12");  // Se aumenta de 10 a 12
    ...
    function updateSpeedometer(speedValue) {
        ...
        // Para la aguja se limita a 100, pero el texto mostrará el valor real
